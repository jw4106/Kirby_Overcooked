...
function setup()
{
  ...
  tableObj2_left = new Interactive(tableleft, 590, 370, false, null);
  tableObj2_middle = new Interactive(tablemiddle, 630, 370, false, null);
  tableObj2_middle2 = new Interactive(tablemiddle, 655, 370, false, null);
  tableObj2_right = new Interactive(tableright, 700, 370, false, null);
